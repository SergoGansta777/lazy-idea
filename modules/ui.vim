...
let g:WhichKeyDesc_ui_diagnostics = "<leader>ud Problems"
...
let g:WhichKeyDesc_ui_background = "<leader>ub Switch Theme"
...
let g:WhichKeyDesc_inspect_tree = "<leader>uI Structure Tool Window"
nmap <leader>uI <Action>(ActivateStructureToolWindow)
