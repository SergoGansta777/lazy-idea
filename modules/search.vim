...
let g:WhichKeyDesc_search_buffer = "<leader>sb Buffers"
...
let g:WhichKeyDesc_search_man = "<leader>sM Hover Documentation"
...
let g:WhichKeyDesc_search_resume = "<leader>sR Search in Files"
nmap <leader>sR <Action>(FindInPath)

let g:WhichKeyDesc_search_symbol = "<leader>ss Goto Symbol"
nmap <leader>ss <Action>(FileStructurePopup)

let g:WhichKeyDesc_search_symbol_workspace = "<leader>sS Goto Symbol in Project"
